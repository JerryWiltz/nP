...
define(['app/lowpassSetup'], function (lowpassSetup){
"use strict";
return function lowpassDesign(ROOT) {	
	"use strict";
	...
	function  doDesign () {
		...
		var frequencyUnits = ROOT.getFrequencyUnits().value;

		var lowPassTable = []; // Table generated
